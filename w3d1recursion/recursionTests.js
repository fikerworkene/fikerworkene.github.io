...
const printListRecursion = myExports.printListRecursion; 
const printListLoop = myExports.printListLoop; 
const printReverseList = myExports.printReverseList; 
const printReverseListLoop = myExports.printReverseListLoop; 
...
describe("recursion tests", function () {
    ...
    it("recursive version prints 1 2 3 4 to console", function () {
        assert.strictEqual(printListRecursion(list), "1 2 3 4 printed to console");
    });
    it("iterative version prints 1 2 3 4 to console", function () {
        assert.strictEqual(printListLoop(list), "1 2 3 4 printed to console");
    }); 

    it("recursive version prints 4 3 2 1 to console", function () {
        assert.strictEqual(printReverseList(list), "4 3 2 1 printed to console");
    });    
    it("loop version prints 4 3 2 1 to console", function () {
        assert.strictEqual(printReverseListLoop(list), "4 3 2 1 printed to console");
    });    
